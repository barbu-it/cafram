...
def test_clsbuilder_func_with_bases():
    ...
    DynCls = NodeMetaclass("Node", (), {"ATTR1":True, "__doc__":"My DocString"}, 
            node_override=True,                        
...
def test_clsbuilder_metaclass_with_class():
    ...
    class DynCls(metaclass=NodeMetaclass, node_prefix='__node__', node_override=False, node_name="Node"):
        "My DocString"
        ATTR1 = True
...
def test_clsbuilder_metaclass_with_class_inheritance_onchildren():
    ...
    class DynCls(Parent, metaclass=NodeMetaclass, node_prefix='__node__', node_override=False, node_name="Node"):
        "My DocString"
        ATTR1 = True
...
def test_clsbuilder_metaclass_with_class_inheritance_on_parent():
    ...
    class Parent(metaclass=NodeMetaclass, node_prefix='__node__', node_override=False, node_name="Node"):
        "Parent Class"
...
def test_clsbuilder_decorator_base():
    ...
    print ("===" * 20)
    node = NodeWrapper(prefix='__node__', 
        override=False, 
        name="Node2",
        attrs=node_attrs,
        )
